...
--nevadaite
	minetest.register_tool("exoticores:helmet_nevadaite", {
		...
		groups = {armor_head=15, armor_heal=10, physics_jump=0.1, armor_fire=1, armor_use=200,physics_gravity=-.01},
		wear = 0,
	})
	minetest.register_tool("exoticores:chestplate_nevadaite", {
		...
		groups = {armor_torso=15, armor_heal=10, physics_jump=0.1, armor_fire=1, armor_use=200,physics_gravity=-.01},
		wear = 0,
	})
	minetest.register_tool("exoticores:leggings_nevadaite", {
		...
		groups = {armor_legs=15, armor_heal=10, physics_jump=0.1, armor_fire=1, armor_use=200,physics_gravity=-.01},
		wear = 0,
	})
	minetest.register_tool("exoticores:boots_nevadaite", {
		...
		groups = {armor_feet=15, armor_heal=10, physics_jump=0.1, armor_fire=1, armor_use=200,physics_gravity=-.01},
		wear = 0,
	})
	minetest.register_tool("exoticores:shield_nevadaite", {
		...
		groups = {armor_shield=15, armor_heal=10, physics_jump=0.1, armor_fire=1, armor_use=200,physics_gravity=-.01},
		wear = 0,
	})
...
--cobaltominite
	minetest.register_tool("exoticores:helmet_cobaltominite", {
		...
		groups = {armor_head=18, armor_heal=20, physics_jump=0.1, armor_fire=2, armor_use=100,physics_gravity=-.02},
		wear = 0,
	})
	minetest.register_tool("exoticores:chestplate_cobaltominite", {
		...
		groups = {armor_torso=18, armor_heal=20, physics_jump=0.1, armor_fire=2, armor_use=100,physics_gravity=-.02},
		wear = 0,
	})
	minetest.register_tool("exoticores:leggings_cobaltominite", {
		...
		groups = {armor_legs=18, armor_heal=20, physics_jump=0.1, armor_fire=2, armor_use=100,physics_gravity=-.02},
		wear = 0,
	})
	minetest.register_tool("exoticores:boots_cobaltominite", {
		...
		groups = {armor_feet=18, armor_heal=20, physics_jump=0.1, armor_fire=2, armor_use=100,physics_gravity=-.02},
		wear = 0,
	})
	minetest.register_tool("exoticores:shield_cobaltominite", {
		...
		groups = {armor_shield=18, armor_heal=20, physics_jump=0.1, armor_fire=2, armor_use=100,physics_gravity=-.02},
		wear = 0,
	})
...
--sideronatrite
	minetest.register_tool("exoticores:helmet_sideronatrite", {
		...
		groups = {armor_head=18, armor_heal=30, physics_jump=0.1, armor_fire=4, armor_use=50,physics_gravity=-.04},
		wear = 0,
	})
	minetest.register_tool("exoticores:chestplate_sideronatrite", {
		...
		groups = {armor_torso=18, armor_heal=30, physics_jump=0.1, armor_fire=4, armor_use=50,physics_gravity=-.04},
		wear = 0,
	})
	minetest.register_tool("exoticores:leggings_sideronatrite", {
		...
		groups = {armor_legs=18, armor_heal=30, physics_jump=0.1, armor_fire=4, armor_use=50,physics_gravity=-.04},
		wear = 0,
	})
	minetest.register_tool("exoticores:boots_sideronatrite", {
		...
		groups = {armor_feet=18, armor_heal=30, physics_jump=0.1, armor_fire=4, armor_use=50,physics_gravity=-.04},
		wear = 0,
	})
	minetest.register_tool("exoticores:shield_sideronatrite", {
		...
		groups = {armor_shield=18, armor_heal=30, physics_jump=0.1, armor_fire=4, armor_use=50,physics_gravity=-.04},
		wear = 0,
	})
...
--edoylerite
	minetest.register_tool("exoticores:helmet_edoylerite", {
		...
		groups = {armor_head=18, armor_heal=40, physics_jump=0.1, armor_fire=6, armor_use=25,physics_gravity=-.08},
		wear = 0,
	})
	...
	minetest.register_tool("exoticores:leggings_edoylerite", {
		...
		groups = {armor_legs=18, armor_heal=40, physics_jump=0.1, armor_fire=6, armor_use=25,physics_gravity=-.08},
		wear = 0,
	})
	minetest.register_tool("exoticores:boots_edoylerite", {
		...
		groups = {armor_feet=18, armor_heal=40, physics_jump=0.1, armor_fire=6, armor_use=25,physics_gravity=-.08},
		wear = 0,
	})
	minetest.register_tool("exoticores:shield_edoylerite", {
		...
		groups = {armor_shield=18, armor_heal=40, physics_jump=0.1, armor_fire=6, armor_use=25,physics_gravity=-.08},
		wear = 0,
	})
...
--lonsdaletite
	minetest.register_tool("exoticores:helmet_lonsdaleite", {
		...
		groups = {armor_head=18, armor_heal=100, physics_jump=0.1, armor_fire=10, armor_use=10,physics_gravity=-.16},
		wear = 0,
	})
	minetest.register_tool("exoticores:chestplate_lonsdaleite", {
		...
		groups = {armor_torso=18, armor_heal=100, physics_jump=0.1, armor_fire=10, armor_use=10,physics_gravity=-.16},
		wear = 0,
	})
	minetest.register_tool("exoticores:leggings_lonsdaleite", {
		...
		groups = {armor_legs=18, armor_heal=100, physics_jump=0.1, armor_fire=10, armor_use=10,physics_gravity=-.16},
		wear = 0,
	})
	minetest.register_tool("exoticores:boots_lonsdaleite", {
		...
		groups = {armor_feet=18, armor_heal=100, physics_jump=0.1, armor_fire=10, armor_use=10,physics_gravity=-.16},
		wear = 0,
	})
	minetest.register_tool("exoticores:shield_lonsdaleite", {
		...
		groups = {armor_shield=18, armor_heal=100, physics_jump=0.1, armor_fire=10, armor_use=10,physics_gravity=-.16},
		wear = 0,
	})
